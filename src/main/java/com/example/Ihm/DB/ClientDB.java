...
public class ClientDB {
    ...
    public void updateClient(Client client) throws SQLException {
        ...
        String updateSql = "UPDATE client SET pseudo=?, mdpCli = ?, mailCli = ?, imgCli = ?, contact=?, adresse=?, acces=? WHERE idCli = ?";
        ...
        try (PreparedStatement statement = conn.prepareStatement(updateSql)) {
            ...
            statement.setString(6,client.getAdresse());
            statement.setBoolean(7,client.getAcces());
            statement.setInt(8, client.getIdCli());
            statement.executeUpdate();
        }
    }
    //update pseudo
    ...
    //update imgCli
    public void updateClientImgCli(Blob imgCli, int idCli) throws SQLException {
        ConnectionDB conndb=new ConnectionDB();
        Connection conn=conndb.connect();
