...
public class ProduitAccueil {
    ...
    public ProduitAccueil(int idPro, int idFr, String design, String descri, int prix, String categorie, int nbClic, byte[] imgPro, int qte, String avis, double vote, String dateAjout) {
        this.idPro = idPro;
        this.idFr = idFr;
        this.design = design;
        this.descri = descri;
